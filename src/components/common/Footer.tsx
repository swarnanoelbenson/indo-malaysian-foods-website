        ...
        <div className="footer__col footer__col--contact">
          ...
          <address className="footer__address">
            <p>
              ...
              <a href="mailto:abc@gmail.com" className="footer__link">
          ...
          <div className="footer__social" aria-label="Social media links">
            ...
            {/* YouTube */}
            <a href="#" className="footer__social-link" aria-label="YouTube" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            {/* X / Twitter */}
            <a href="#" className="footer__social-link" aria-label="X (Twitter)" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
